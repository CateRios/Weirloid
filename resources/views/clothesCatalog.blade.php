    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <section class="filters col-md-2">
                ...
                <form name='form' id='filterForm' action='searchClothes' method='post' enctype="multipart/form-data">
                {{ csrf_field() }}
                <!-- Type -->
                    <section>
                        <p>Tipo</p>
                ...
                <div class="section">
                    ...
                    <div class="productsBackground">
                        <div class="card-columns productList">
                            {{\App\Http\Controllers\ClothesCatalogController::getNewProducts()}}
                        </div>
                    </div>
                    ...
                    <div class="section" id="section-div">
                        ...
                        <div class="productsBackground">
                            <div class="card-columns productList">
                                {{\App\Http\Controllers\ClothesCatalogController::getProducts()}}
                            </div>
                        </div>
                    </div>
                </div>
